...
function addTask(){
    ...
    // Validate a existing task
        ...
        showNotification('Task added sucessfully','#45cfa1'); //! Function call: To show task added message
...
function createTaskElement(task) {
    ...
    aTask.setAttribute('data-task-id', task.id); 
    ...
    aTask.innerHTML = ` <div class="cbox">
                            ...
                            <img src="${task.completed ? 'img2/tick.png' : 'img2/untick.png'}" alt="checkbox">
                            </button>
                        </div>
                        <div class="eachtask">
                        ...
                        <div class="savecancel" id="save-${task.id}" style="display:none">
                            ...
                            <img src="img2/save.png" alt="save icon">
                            </button>  <!--//? Save button-->
                            <button onclick="cancelEdit(${task.id})"> <!--//! Function call: To cancel editing a task-->
                            <img src="img2/cancel.png" alt="cancel icon">
...
function deleteTask(taskId) {
    ...
    showNotification('Task deleted sucessfully!','#45cfa1'); //! Function call: To show task deleted message
...
function toggleEdit(taskId) {
    ...
    taskText.style.borderBottom = '2px solid #45cfa1'; // Highlight the bottom border

    //* Event listner to change error cue on typing
    taskText.addEventListener('input', () => {
        taskText.style.borderBottom = '2px solid #45cfa1';
    });
...
function saveTask(taskId) {
    ...
    showNotification('Task updated sucessfully!','#45cfa1'); //! Function call: To show task updated message
...
function clearAllTasks() {
    ...
    showNotification('All tasks cleared!','#45cfa1'); //! Function call: To show all tasks cleared message
